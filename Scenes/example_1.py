...
scene_objects = [objects.Sphere(x=0, y=0, z=-1000000, radius=1000000,
                 ...
                 objects.Sphere(x=4, y=0, z=1, radius=1,
                                material=materials.Material(diffuse_color=BLUE, reflection_coefficient=0.1, shininess=10)),
                 objects.Sphere(y=2, z=1.25, radius=0.5,
                                material=materials.Material(diffuse_color=YELLOW, reflection_coefficient=0.5))]
