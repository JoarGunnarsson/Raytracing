...
my_cube = objects.Cuboid(x=0, y=0, z=0.7, v1=np.array([1.0, 0.0, 0.0]), v2=np.array([0.0, 1.0, 0.0]),
                         ...
                         material=materials.Material(diffuse_color=colors.RED, smoothness=1, transparency_coefficient=0.5, refractive_index=1.5, attenuation_coefficient=0.5))
