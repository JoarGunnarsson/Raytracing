...
scene_objects = [objects.Sphere(z=-10000000, radius=10000000,
                 ...
                 objects.Sphere(x=0, y=0, z=1, radius=1,
                                material=materials.Material(diffuse_color=RED, reflection_coefficient=0, specular_coefficient=1,
...
light_sources = [objects.DiskSource(x=4, y=0, z=10, intensity=10 ** 2, radius=4)]
