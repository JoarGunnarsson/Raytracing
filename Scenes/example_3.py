...
scene_objects = [objects.Sphere(z=-10000000, radius=10000000,
                ...
                objects.Sphere(x=-10 - 1000, z=2, radius=1000,
                                material=materials.Material(diffuse_color=RED, reflection_coefficient=0, transparency_coefficient=0, refractive_index=1))
                 ]
